...
import com.lwl.mapper.TicketMapper;
...
public class TicketServiceImpl implements TicketService {
    ...
    @RabbitExecutorErrorRouting(exchange = Constant.EXEC_ERROR_EXCHANGE,routingKey = Constant.EXEC_ERROR_QUEUE,desc = "索票操作")
    public void handleTicketLock(OrderContextDTO orderContextDTO) {
        ...
        sendMessage(orderContextDTO, Constant.ORDER_FAIL_ROUTING_KEY);
    }
    ...
    @Transactional(transactionManager = "rabbitAndDbTransactionManager")
    @RabbitExecutorErrorRouting(exchange = Constant.EXEC_ERROR_EXCHANGE,routingKey = Constant.EXEC_ERROR_QUEUE,desc = "解锁票操作")
    ...
    @Transactional(transactionManager = "rabbitAndDbTransactionManager")
    @RabbitExecutorErrorRouting(exchange = Constant.EXEC_ERROR_EXCHANGE,routingKey = Constant.EXEC_ERROR_QUEUE,desc = "交票操作")
